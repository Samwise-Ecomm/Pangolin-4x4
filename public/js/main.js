...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/app.vue"
  if (!module.hot.data) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/components/cart.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/components/catalog.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/components/contactInfo.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n\t<span class=\"fa fa-chevron-left u-active\" @click=\"changePage(page - 1)\"></span>&nbsp;\n\t<span :class=\"(page == 1)?'u-highlight':'u-active'\" @click=\"changePage(1)\">1</span>\n\t<span v-if=\"page > 3\">...</span>\n\t<span class=\"u-active\" @click=\"changePage(page - 1)\" v-if=\"page > 2\">{{ page - 1}}</span>\n\t<span class=\"u-highlight\" v-if=\"page > 1 &amp;&amp; page < pages\">{{ page }}</span>\n\t<span class=\"u-active\" @click=\"changePage(page + 1)\" v-if=\"page < pages - 1\">{{ page + 1 }}</span>\n\t<span v-if=\"page < pages - 2\">...</span>\n\t<span :class=\"(page == pages)?'u-highlight':'u-active'\" @click=\"changePage(pages)\">{{ pages }}</span>\n\t<span class=\"fa fa-chevron-right u-active\" @click=\"changePage(page + 1)\"></span>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/components/pageCounter.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/components/search.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/components/submitCheckout.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/pages/404.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/pages/catalog.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/pages/checkout.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
module.exports = {
	...
	methods: {
		getOffer: function getOffer() {
			...
			this.$http.get('/public-api/offer/' + this.$route.params.id).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/pages/item.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TJTorola/Sites/Samwise/storefront/assets/js/pages/page.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
